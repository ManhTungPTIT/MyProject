    ...
    public partial class MyProject : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdminCustomer", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdminCustomer_Admin_AdminId",
                        column: x => x.AdminId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdminEmployee", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdminEmployee_Admin_AdminId",
                        column: x => x.AdminId,
                        principalTable: "Admin",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AdminEmployee_Employees_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdminEmployee_EmployeeId",
                table: "AdminEmployee",
                column: "EmployeeId");
